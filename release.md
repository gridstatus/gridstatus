...
3. Run `make test-slow` to ensure slow tests that CI doesn't check are passing (note: we haven't done this in a while. Unclear if we should continue doing this)
